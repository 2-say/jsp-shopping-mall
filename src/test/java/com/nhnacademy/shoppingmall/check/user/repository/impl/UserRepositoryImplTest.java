...
class UserRepositoryImplTest {
    ...
    void save() {
        ...
        Assertions.assertAll(() -> Assertions.assertEquals(1, result), () -> Assertions.assertEquals(newUser, userRepository.findById(newUser.getUserId()).get()));
    }
    ...
    void deleteByUserId() {
        ...
        Assertions.assertAll(() -> Assertions.assertEquals(1, result), () -> Assertions.assertFalse(userRepository.findById(testUser.getUserId()).isPresent()));
    }
    ...
    void update() {
        ...
        Assertions.assertAll(() -> Assertions.assertEquals(1, result), () -> Assertions.assertEquals(testUser, userRepository.findById(testUser.getUserId()).get()));
    }

...
public class ProductEditController implements BaseController {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        Product product = new Product(productId, productName, productPrice, description, productField, LocalDateTime.now());
        ...
        productService.updateProduct(product, categoryId, Optional.ofNullable((List<String>) req.getAttribute("fileNames")));
